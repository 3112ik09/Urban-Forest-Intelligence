...
const OVERRIDES: Record<string, Partial<CityConfig>> = {
  ...
  london:    { displayName: 'London',    country: 'UK',      defaultBbox: [-0.489, 51.286, 0.236, 51.686],  bareThreshold: 0.15, targetCanopyPct: 0.40, geeScale: 10 },
  new:       { displayName: 'New York',  country: 'USA',     defaultBbox: [-74.259, 40.478, -73.700, 40.917], bareThreshold: 0.15, targetCanopyPct: 0.35, geeScale: 10 },
